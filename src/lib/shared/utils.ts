 ...
 * 
 * Cross-service utilities that don't belong to a specific service
 */
 ...
 */
export function formatPercentage(value: number, includeSign: boolean = false, decimals: number = 2): string {
...
/**
 * Get current trading date (market close is 4 PM ET)
 */
 ...
 */
export function getEnvironmentBadgeColor(environment: 'paper' | 'live'): string {
  switch (environment) {
    case 'paper':
